/**
 * The `Scope` component displays a point on an x-y axis. It is
 * useful for visualizing animation parameters.
 */
...
export default function Scope({ title, x=0, y=0, xScale=1, yScale=1, width=350, height=350 }) {
